...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/rrhh/reclutamiento", label: "Reclutamiento", icon: Briefcase, modulo: "rrhh" },
    ],
  },
  {
    titulo: "Gestión",
...
export const COMMAND_ITEMS: CommandItem[] = [
  ...
  { label: "Reclutamiento", href: "/rrhh/reclutamiento", grupo: "Recursos Humanos", modulo: "rrhh", keywords: "vacantes candidatos" },
