...
async function ensureEstaciones(tx, empresaId, sucursalId) {
  const data = [
    ...
    { nombre: "Cafe y bebidas", tipo: "bar", orden: 5 },
    { nombre: "Despacho delivery", tipo: "cocina", orden: 6 },
  ];
  const out = {};
...
async function ensureMesas(tx, empresaId, sucursalId, areas) {
  const data = [
    ...
    ["R2", "Reservado", 10, "disponible", "rectangular", 0.88, 0.78],
    ["P1", "Patio familiar", 4, "disponible", "redonda", 0.16, 0.90],
    ["P2", "Patio familiar", 4, "ocupada", "redonda", 0.32, 0.90],
    ["P3", "Patio familiar", 6, "disponible", "rectangular", 0.50, 0.90],
    ["P4", "Patio familiar", 8, "reservada", "rectangular", 0.70, 0.90],
    ["D1", "Delivery y pick-up", 1, "ocupada", "barra", 0.88, 0.90],
    ["D2", "Delivery y pick-up", 1, "disponible", "barra", 0.96, 0.90],
  ];
  const out = {};
...
async function ensureProductos(tx, empresaId, categorias, unidades, estaciones, almacenId, usuarioId) {
  ...
  const insumos = [
    ...
    {
      key: "tortilla",
      sku: "NIC-INS-TORTILLA",
      nombre: "Tortilla de maiz artesanal",
      unidad: "UND",
      costo: 4,
      minimo: 120,
      stock: 180,
    ...
    },
    {
      key: "cerdo",
      sku: "NIC-INS-CERDO",
      nombre: "Costilla de cerdo marinada",
      unidad: "KG",
      costo: 138,
      minimo: 14,
      stock: 19,
    ...
    },
    {
      key: "pescado",
      sku: "NIC-INS-PESCADO",
      nombre: "Filete de pescado fresco",
      unidad: "KG",
      costo: 164,
      minimo: 10,
      stock: 13,
    ...
    {
      key: "quesillo",
      sku: "NIC-INS-QUESILLO",
      nombre: "Quesillo nacional",
      unidad: "KG",
      costo: 128,
      minimo: 7,
      stock: 9,
  ...
  const platillos = [
    ...
    },
    {
      key: "desayunoTipico",
      sku: "NIC-DES-TIPICO",
      nombre: "Desayuno tipico Nicaris",
      descripcion: "Gallo pinto, huevo, queso, maduro, crema y tortilla.",
      categoria: "Desayunos",
      precio: 185,
      costo: 67,
      estacion: "Cocina caliente",
      tiempo: 10,
      tags: ["desayuno", "tipico"],
      ingredientes: [
        ["galloPinto", 0.22, 58],
        ["huevo", 2, 6],
        ["quesillo", 0.05, 128],
    ...
    {
      key: "nacatamal",
      sku: "NIC-DES-NACATAMAL",
      nombre: "Nacatamal de la casa",
      descripcion: "Nacatamal servido con pan, cafe negro y encurtido.",
      categoria: "Desayunos",
      precio: 155,
      costo: 54,
      estacion: "Cocina caliente",
    ...
    {
      key: "costillaBbq",
      sku: "NIC-PLT-COSTILLA",
      nombre: "Costilla BBQ pinolera",
      descripcion: "Costilla glaseada, yuca frita y ensalada criolla.",
      categoria: "Parrilla",
      precio: 340,
      costo: 126,
      estacion: "Parrilla",
      tiempo: 20,
      tags: ["parrilla", "favorito"],
      ingredientes: [
        ["cerdo", 0.32, 138],
        ["salsa", 0.06, 65],
        ["lechuga", 0.08, 42],
    ...
    },
    {
      key: "pescadoTisma",
      sku: "NIC-MAR-PESCADO",
      nombre: "Pescado Tisma al ajillo",
      descripcion: "Filete al ajillo con arroz, vegetales y limon.",
      categoria: "Mariscos",
      precio: 315,
      costo: 118,
      estacion: "Cocina caliente",
    ...
    },
    {
      key: "tostonesCamaron",
      sku: "NIC-ENT-CAMARON",
      nombre: "Tostones con camaron",
      descripcion: "Tostones crujientes con camaron salteado y salsa criolla.",
      categoria: "Entradas",
      precio: 235,
      costo: 88,
      estacion: "Cocina caliente",
    ...
    {
      key: "quesilloNicaris",
      sku: "NIC-ENT-QUESILLO",
      nombre: "Quesillo Nicaris",
      descripcion: "Quesillo con cebolla encurtida, crema y tortilla caliente.",
      categoria: "Entradas",
      precio: 120,
      costo: 42,
      estacion: "Barra fria",
    ...
    },
    {
      ...
      sku: "NIC-BEB-CACAO",
      nombre: "Cacao helado",
      descripcion: "Bebida fria de cacao, leche y especias dulces.",
      categoria: "Bebidas",
      precio: 95,
      costo: 28,
      estacion: "Cafe y bebidas",
      tiempo: 5,
      tags: ["bebida", "tradicional"],
      ingredientes: [["cacao", 0.04, 188]],
    },
    {
      key: "macua",
      sku: "NIC-COC-MACUA",
      nombre: "Macua Nicaris",
      descripcion: "Ron nacional, guayaba, naranja y limon.",
      categoria: "Cocteles",
      precio: 165,
      costo: 52,
      estacion: "Cafe y bebidas",
      tiempo: 6,
      tags: ["coctel"],
      ingredientes: [["maracuya", 0.04, 92]],
    },
    {
      key: "flanCafe",
      sku: "NIC-POS-FLAN",
      nombre: "Flan de cafe",
      descripcion: "Flan cremoso con caramelo y cafe Matagalpa.",
      categoria: "Postres",
      precio: 125,
      costo: 38,
      estacion: "Postres",
    ...
    {
      key: "tresLeches",
      sku: "NIC-POS-TRESLECHES",
      nombre: "Tres leches de cacao",
      descripcion: "Bizcocho tres leches con cacao y crema batida.",
      categoria: "Postres",
      precio: 140,
      costo: 45,
      estacion: "Postres",
...
async function ensureMenuPlatillos(tx, empresaId, menuId, productos) {
  const secciones = [
    ["Desayunos", "Mananas nicas y cafe.", 1],
    ["Entradas", "Para abrir mesa o compartir.", 2],
    ["Platos fuertes", "Favoritos de la casa.", 3],
    ["Parrilla", "Cortes, brasas y platos fuertes.", 4],
    ["Mariscos", "Sabores frescos de temporada.", 5],
    ["Bebidas", "Barra fria y cafe.", 6],
    ["Cocteles", "Tragos de autor.", 7],
    ["Postres", "Cierre dulce.", 8],
  ];
  const seccionIds = {};
  ...
  const items = [
    [productos.desayunoTipico, "Desayunos", true, "Especial", 1],
    [productos.nacatamal, "Desayunos", true, null, 2],
    [productos.ensalada, "Entradas", true, null, 1],
    [productos.tostonesCamaron, "Entradas", true, "Nuevo", 2],
    [productos.quesilloNicaris, "Entradas", false, null, 3],
    ...
    [productos.costillaBbq, "Parrilla", true, null, 1],
    [productos.pescadoTisma, "Mariscos", true, null, 1],
    [productos.cafeFrio, "Bebidas", true, null, 1],
    [productos.limonada, "Bebidas", false, "Refrescante", 2],
    [productos.cacaoHelado, "Bebidas", true, null, 3],
    [productos.macua, "Cocteles", true, "Casa", 1],
    [productos.cheesecake, "Postres", true, "Favorito", 1],
    [productos.flanCafe, "Postres", false, null, 2],
    [productos.tresLeches, "Postres", true, null, 3],
  ];
...
async function ensureComensales(tx, empresaId) {
  const data = [
    ...
    ["Mariana Castillo", "+50588101006", "mariana@nicaris.demo", 22, 16240, "Desayuno tipico sin crema", "Ninguna"],
    ["Jose Alvarez", "+50588101007", "jose@nicaris.demo", 18, 13890, "Parrilla termino medio", "Ninguna"],
    ["Paola Gutierrez", "+50588101008", "paola@nicaris.demo", 11, 7840, "Coctel sin azucar", "Ninguna"],
    ["Equipo CafeLab", "+50588101009", "cafelab@nicaris.demo", 7, 9280, "Factura corporativa", "Ninguna"],
    ["Diana Morales", "+50588101010", "diana@nicaris.demo", 14, 9940, "Mesa tranquila", "Gluten"],
    ["Oscar Bermudez", "+50588101011", "oscar@nicaris.demo", 6, 4760, "Extra picante", "Mariscos"],
    ["Familia Aguirre", "+50588101012", "aguirre@nicaris.demo", 10, 10550, "Cumpleanos infantiles", "Ninguna"],
    ["Claudia Rivas", "+50588101013", "claudia@nicaris.demo", 19, 14220, "Cafe doble", "Lactosa"],
  ];
  const out = {};
...
async function ensureOrdenesDemo(
  ...
  const ordenes = [
    ...
    },
    {
      ...
      mesa: "P2",
      mesero: "MES-04",
      comensal: "Mariana Castillo",
      estado: "abierta",
      personas: 2,
      hora: [8, 20],
      items: [
        ["desayunoTipico", 2, "entregado"],
        ["cacaoHelado", 1, "listo"],
        ["cafeFrio", 1, "listo"],
      ],
      comandaEstado: "lista",
    ...
    },
    {
      ...
      mesa: "P4",
      mesero: "MES-05",
      comensal: "Jose Alvarez",
      estado: "pagada",
      personas: 4,
      hora: [12, 5],
      items: [
        ["costillaBbq", 2, "entregado"],
        ["pescadoTisma", 1, "entregado"],
        ["limonada", 4, "entregado"],
      ],
      venta: true,
      comandaEstado: "entregada",
      estacion: "Parrilla",
    },
    {
      ...
      mesa: "B2",
      mesero: "MES-06",
      comensal: "Paola Gutierrez",
      estado: "abierta",
      personas: 2,
      hora: [18, 25],
      items: [
        ["macua", 2, "listo"],
        ["tostonesCamaron", 1, "preparando"],
      ],
      comandaEstado: "preparando",
      estacion: "Cafe y bebidas",
    },
    {
      ...
      mesa: "D1",
      mesero: "MES-07",
      comensal: "Equipo CafeLab",
      estado: "en_cocina",
      personas: 1,
      hora: [12, 50],
      items: [
        ["hamburguesa", 4, "preparando"],
        ["tacos", 3, "preparando"],
        ["tresLeches", 4, "enviado"],
      ],
      comandaEstado: "preparando",
      estacion: "Despacho delivery",
    },
    {
      n: 13,
      mesa: "R2",
      mesero: "MES-04",
      comensal: "Diana Morales",
      estado: "cuenta_solicitada",
      personas: 6,
      hora: [19, 15],
      items: [
        ["pollo", 2, "entregado"],
        ["pescadoTisma", 2, "entregado"],
        ["flanCafe", 3, "entregado"],
      ],
      comandaEstado: "entregada",
      estacion: "Cocina caliente",
    },
    {
      ...
      mesa: "M7",
      mesero: "MES-05",
      comensal: "Oscar Bermudez",
      estado: "pagada",
      personas: 2,
      hora: [20, 5],
      items: [
        ["tostonesCamaron", 1, "entregado"],
        ["costillaBbq", 1, "entregado"],
        ["macua", 2, "entregado"],
      ],
      venta: true,
      comandaEstado: "entregada",
    ...
    },
    {
      ...
      mesa: "P3",
      mesero: "MES-06",
      comensal: "Familia Aguirre",
      estado: "pagada",
      personas: 5,
      hora: [13, 45],
      items: [
        ["quesilloNicaris", 2, "entregado"],
        ["hamburguesa", 2, "entregado"],
        ["tresLeches", 3, "entregado"],
      ],
      venta: true,
      comandaEstado: "entregada",
      estacion: "Cocina caliente",
    },
    {
      ...
      mesa: "B3",
      mesero: "MES-07",
      comensal: "Claudia Rivas",
      estado: "pagada",
      personas: 1,
      hora: [16, 30],
      items: [
        ["cafeFrio", 1, "entregado"],
        ["flanCafe", 1, "entregado"],
      ],
      venta: true,
      comandaEstado: "entregada",
      estacion: "Cafe y bebidas",
...
async function ensureRecepcionDemo(tx, empresaId, sucursalId, usuarioId, mesas, comensales) {
  const reservas = [
    ...
    ["Jose Alvarez", "+50588101007", "jose@nicaris.demo", addDays(0), "19:45", 4, "Cena de parrilla", "P4"],
    ["Diana Morales", "+50588101010", "diana@nicaris.demo", addDays(1), "20:00", 6, "Reunion tranquila", "R2"],
    ["Familia Aguirre", "+50588101012", "aguirre@nicaris.demo", addDays(3), "13:00", 8, "Cumpleanos infantil", "P3"],
    ["Claudia Rivas", "+50588101013", "claudia@nicaris.demo", addDays(4), "16:30", 2, "Cafe y postre", "B3"],
  ];
  ...
  const espera = [
    ...
    ["Delivery Oficina Norte", "+50588102004", 8, 35, "Pick-up"],
    ["Pareja patio", "+50588102005", 2, 14, "Patio familiar"],
    ["Turistas Granada", "+50588102006", 6, 28, "Reservado"],
    ["Mesa con silla bebe", "+50588102007", 4, 22, "Patio familiar"],
  ];
...
async function ensureMarketingDemo(tx, empresaId, usuarioId, productos, categorias) {
  const promos = [
    ...
    ["Desayuno temprano", "10% en desayunos antes de las 9am", "porcentaje", 10, productos.desayunoTipico.id],
    ["Parrilla familiar", "Costilla BBQ con bebidas para mesas de 4+", "precio_fijo", 1190, productos.costillaBbq.id],
    ["Postre despues de las 8", "Tres leches con precio especial por la noche", "precio_fijo", 110, productos.tresLeches.id],
    ["Macua de la casa", "2 Macua Nicaris a precio de celebracion", "precio_fijo", 280, productos.macua.id],
  ];
...
async function ensureMermasDemo(tx, empresaId, sucursalId, almacenId, usuarioId, productos) {
  const rows = [
    [productos.lechuga.id, 0.7, 42, "preparacion", `${LEGACY_SEED_MARKER} corte de hojas para mise en place`],
    [productos.pan.id, 4, 18, "caducidad", `${LEGACY_SEED_MARKER} panes vencidos antes de servicio`],
    [productos.pescado.id, 0.45, 164, "preparacion", `${LEGACY_SEED_MARKER} recorte de filetes para servicio nocturno`],
    [productos.camaron.id, 0.32, 225, "desperdicio", `${LEGACY_SEED_MARKER} descarte por control de olor y textura`],
    [productos.platano.id, 1.2, 36, "preparacion", `${LEGACY_SEED_MARKER} merma de puntas para tostones`],
    [productos.galloPinto.id, 0.8, 58, "otro", `${LEGACY_SEED_MARKER} sobrante de desayuno no reutilizable`],
  ];
