...
export const restauranteMesas = pgTable(
  "restaurante_mesas",
  {
    ...
    rotacion: numeric("rotacion", { precision: 8, scale: 4 }).notNull().default("0"),
    ...
    estadoOverrideManual: boolean("estado_override_manual").notNull().default(false),
    estadoOverrideUsuarioId: uuid("estado_override_usuario_id").references(() => usuarios.id),
    estadoOverrideMotivo: text("estado_override_motivo"),
    estadoOverrideEn: timestamp("estado_override_en", { withTimezone: true }),
