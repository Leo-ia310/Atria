...
async function main(): Promise<void> {
  ...
  const [ownerMembership, adminMembership, workerMembership] =
    await Promise.all([
  ...
  const tax = await prisma.taxRate.upsert({
    ...
    update: { rate: new Prisma.Decimal(15), isDefault: true },
    create: {
      organizationId: organization.id,
      code: 'IVA15',
      name: 'IVA general',
  ...
  const products = await Promise.all([
    prisma.product.upsert({
      ...
      create: {
        ...
        unit: 'unidad',
        salePrice: new Prisma.Decimal(18.5),
        costPrice: new Prisma.Decimal(11.2),
    ...
    prisma.product.upsert({
      ...
      create: {
        ...
        unit: 'unidad',
        salePrice: new Prisma.Decimal(2.75),
        costPrice: new Prisma.Decimal(1.2),
        minStock: new Prisma.Decimal(40),
      },
    }),
    prisma.product.upsert({
      where: {
      ...
      create: {
        ...
        unit: 'unidad',
        salePrice: new Prisma.Decimal(139.99),
        costPrice: new Prisma.Decimal(98.5),
  ...
  const customer = await prisma.customer.upsert({
    ...
    create: {
      ...
      balance: new Prisma.Decimal(420),
    },
  });
  ...
  const quotation = await prisma.quotation.upsert({
    ...
    create: {
      ...
      number: 'COT-000001',
      status: 'DRAFT',
      subtotal: new Prisma.Decimal(37),
      taxTotal: new Prisma.Decimal(5.55),
      discountTotal: new Prisma.Decimal(0),
      grandTotal: new Prisma.Decimal(42.55),
  ...
  if (!existingQuotationItem) {
    await prisma.quotationItem.create({
      data: {
        ...
        unitPrice: new Prisma.Decimal(18.5),
        taxAmount: new Prisma.Decimal(5.55),
        discountAmount: new Prisma.Decimal(0),
        lineTotal: new Prisma.Decimal(42.55),
      },
    });
  }
  ...
  const sale = await prisma.sale.upsert({
    ...
    create: {
      ...
      type: 'POS',
      status: 'COMPLETED',
      subtotal: new Prisma.Decimal(162.74),
      taxTotal: new Prisma.Decimal(24.41),
      discountTotal: new Prisma.Decimal(5),
      paidTotal: new Prisma.Decimal(187.15),
      grandTotal: new Prisma.Decimal(182.15),
      ...
      data: [
        {
          ...
          unitPrice: new Prisma.Decimal(139.99),
          unitCost: new Prisma.Decimal(98.5),
          taxAmount: new Prisma.Decimal(21),
          discountAmount: new Prisma.Decimal(5),
          lineTotal: new Prisma.Decimal(155.99),
        },
        {
          saleId: sale.id,
          productId: products[1].id,
          quantity: new Prisma.Decimal(2),
          unitPrice: new Prisma.Decimal(2.75),
          unitCost: new Prisma.Decimal(1.2),
          taxAmount: new Prisma.Decimal(0.82),
          discountAmount: new Prisma.Decimal(0),
          lineTotal: new Prisma.Decimal(6.32),
        },
      ],
    });
  }
  ...
  if (!existingPayment) {
    await prisma.payment.create({
      data: {
        ...
        branchId: branchCentral.id,
        method: 'CARD',
        amount: new Prisma.Decimal(182.15),
  ...
  await prisma.receivable.upsert({
    ...
    update: {
      ...
      originalAmount: new Prisma.Decimal(420),
      outstandingAmount: new Prisma.Decimal(420),
      status: 'PENDING',
    },
    create: {
      organizationId: organization.id,
    ...
    data: [
      {
        ...
        taxTotal: new Prisma.Decimal(9.75),
        total: new Prisma.Decimal(74.75),
      ...
      },
      {
        ...
        taxTotal: new Prisma.Decimal(6),
        total: new Prisma.Decimal(46),
  ...
  if (!payableExists) {
    await prisma.payable.create({
      data: {
        ...
        originalAmount: new Prisma.Decimal(520),
        outstandingAmount: new Prisma.Decimal(520),
        status: 'PENDING',
      },
    });
  }
  ...
  await prisma.billingInvoice.upsert({
    ...
    create: {
      ...
      amountDue: new Prisma.Decimal(399),
      amountPaid: new Prisma.Decimal(399),
      currencyCode: 'USD',
      status: 'PAID',
    },
  });
